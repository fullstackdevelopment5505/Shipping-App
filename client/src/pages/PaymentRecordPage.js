...
class PaymentRecordPage extends React.Component {
          ...
          <Table hover bordered>
            <thead>
              ...
              <tr style={{backgroundColor: '#98a2e9', color: 'white', cursor: 'pointer' }}>
                ...
                <th style={{width: '8%', textAlign: 'center'}} onClick={this.sortData('amountPaid')}>Amount Paid <ImportExportIcon style={{fontSize: 20}}/></th>
              </tr>
            </thead>
            <tbody>
  
              {this.state.items.map(({ number, packagePicture, trackingNo, shopName, description, quantity,date1, date2, status, receiptNo, paymentMode, amountPaid }, index) => (
                  <tr key={index}>
