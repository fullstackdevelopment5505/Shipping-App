...
class OrderAdminPage extends React.Component {
  ...
  render() {
    return (
      <Page title="Successful Order" style={{fontFamily: "Arial, sans-serif" }}>
          ...
          <Table hover bordered>
            <thead>
              ...
              <tr style={{backgroundColor: '#98a2e9', color: 'white', cursor: 'pointer' }}>
                ...
                <th style={{width: '8%', textAlign: 'center'}} onClick={this.sortData('amountPaid')}>Price <ImportExportIcon style={{fontSize: 20}}/></th>
              </tr>
            </thead>
            <tbody>
