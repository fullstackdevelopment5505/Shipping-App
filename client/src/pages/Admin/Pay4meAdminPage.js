...
class Pay4meAdminPage extends React.Component {
  ...
  render() {
    return (
      <Page title="Pay 4 Me Record" style={{fontFamily: "Arial, sans-serif" }}>
          ...
          <Table hover bordered>
            <thead>
              ...
              <tr style={{backgroundColor: '#98a2e9', color: 'white', cursor: 'pointer' }}>
                ...
                <th style={{width: '13%', textAlign: 'center'}} onClick={this.sortData('paymentMode')}>Mode of Payment <ImportExportIcon style={{fontSize: 20}}/></th>
                <th style={{width: '8%', textAlign: 'center'}} onClick={this.sortData('amountPaid')}>Amount <ImportExportIcon style={{fontSize: 20}}/></th>
                <th style={{width: '8%', textAlign: 'center'}} onClick={this.sortData('amountPaid')}>Status <ImportExportIcon style={{fontSize: 20}}/></th>
                <th style={{width: '3%', textAlign: 'center'}} onClick={this.sortData('amountPaid')}>Note </th>
              </tr>
            </thead>
            <tbody>
              ...
              {this.state.items.map(({ number, userName, packagePicture, trackingNo, shopName, description, quantity,date1, date2, status, receiptNo, paymentMode, amountPaid }, index) => (
                  <tr key={index}>
                    ...
                    <td style={{textAlign: 'center', cursor: 'pointer'}} onClick={this.toggle()}>{status}</td>
                    <td style={{textAlign: 'center', cursor: 'pointer'}} onClick={this.toggle()}></td>
                  </tr>
              ))}                 
                    ...
                    <Table hover>
                        <thead>
                            <tr style={{cursor: 'pointer' }}>
                                ...
                                <th style={{width: '19%', textAlign: 'center'}}>Item Name</th>
...
export default Pay4meAdminPage;
