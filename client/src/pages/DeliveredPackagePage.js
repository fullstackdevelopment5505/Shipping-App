...
class DeliveredPackagePage extends React.Component {
      ...
      <Row>
        <Table striped hover>
          ...
          <tbody>
            ...
            {deliveredPackages.map(({ number, itemName, description, unitPrice, quantity }, index) => (
                <tr key={index} style={{cursor: 'pointer'}}>
                  ...
                  <td style={{width: '50%', textAlign: 'center'}} onClick={this.toggle()}>{description}</td>
                  ...
                  <td style={{width: '5%', textAlign: 'center'}}><Button color='success'>Ship</Button></td>
                </tr>
            ))}
...
export default DeliveredPackagePage;
