...
const navItems = [
  ...
  { to: '/receivedPackage', name: 'Received Package', exact: false, Icon: MdStore },
  { to: '/shippedPackage', name: 'Shipped Package', exact: false, Icon: MdLocalShipping },
...
const navItems2 = [
  { to: '/paymentRecord', name: 'Payment Record', exact: true, Icon: MdAttachMoney },
